...
*
* The degree of the result will be the least of the degrees of `G`, `H`, and `I`. If any of the
* inputs is a real number, it will be converted to a constant `GDN` with the same degree as the
